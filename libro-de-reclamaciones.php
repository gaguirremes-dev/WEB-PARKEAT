...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$nombres || !$doc_tipo || !$doc_nro || !$email || !$direccion || !$bien_tipo || !$reclamo_tipo || !$detalle || !$pedido || !empty($errorMsg)) {
        ...
        if ($success) {
            ...
            $subjectCliente = "Cargo de Hoja de Reclamación N° $generatedCode - Parkeat";
            $emailBody = "
            <div style='font-family:Arial,sans-serif;color:#333;max-width:600px;margin:0 auto;border:1px solid #e0e0e0;border-radius:8px;overflow:hidden;'>
                <div style='background:#1E40AF;padding:25px;text-align:center;'>
                    ...
                    <p style='margin:5px 0 0;color:#BFDBFE;font-size:14px;font-weight:bold;'>Código: $generatedCode</p>
                </div>
            ...
            <div style='font-family:Arial,sans-serif;color:#333;max-width:600px;margin:0 auto;border:1px solid #e0e0e0;border-radius:8px;padding:25px;'>
                ...
                <div style='background:#f7f7f7;padding:12px;border-left:4px solid #3B82F6;'><strong>Pedido:</strong><br>" . nl2br($pedido) . "</div>
            </div>";
