 ...
 */
define('SMTP_HOST', 'mail.parkeatcar.com');
define('SMTP_PORT', 465);
define('SMTP_USER', 'reclamaciones@parkeatcar.com');
define('SMTP_PASS', 'TU_CONTRASEÑA_AQUI');
define('SMTP_FROM_NAME', 'Parkeat');

define('EMPRESA_NOTIF_EMAIL', 'reclamaciones@parkeatcar.com');
